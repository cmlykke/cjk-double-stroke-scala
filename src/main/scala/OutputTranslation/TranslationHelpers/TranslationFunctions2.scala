...
object TranslationFunctions2 {
  ...
  def generateReadyCodeForTwo(unambigous: List[Set[ConwayUnambigous]]): Set[String] = {
    ...
    for (conLi <- combinations) {
      val part1: String = getFirstSecondAndLast(conLi(0))//getFirstAndLast(conLi(0))
      val part2: String = getFirstAndLast(conLi(1))//getFirstSecondAndLast(conLi(1))
      res.add(part1+part2)
    }
  ...
  def generateReadyCodeForThree(unambigous: List[Set[ConwayUnambigous]]): Set[String] = {
    ...
    var res: mutable.Set[String] = mutable.Set[String]()
    for (conLi <- combinations) {
      val part1: String = getFirstSecondAndLast(conLi(0))//getFirst(conLi(0))
      val part2: String = getFirstAndLast(conLi(1))//getFirstAndLast(conLi(1))
      val part3: String = getFirst(conLi(2))//getFirstSecondAndLast(conLi(2))
  ...
  def generateReadyCodeForFour(unambigous: List[Set[ConwayUnambigous]]): Set[String] = {
    ...
    var res: mutable.Set[String] = mutable.Set[String]()
    for (conLi <- combinations) {
      val part1: String = getFirstAndLast(conLi(0))//getFirst(conLi(0))
      val part2: String = getFirstAndLast(conLi(1))//getFirst(conLi(1))
      val part3: String = getFirst(conLi(2))//getFirstAndLast(conLi(2))
      val part4: String = getFirst(conLi(3))//getFirstAndLast(conLi(3))
  ...
  def generateReadyCodeOverFive(unambigous: List[Set[ConwayUnambigous]]): Set[String] = {
    val combinations: List[List[ConwayUnambigous]] = generateCombinations(unambigous)
    var res: mutable.Set[String] = mutable.Set[String]()
    for (conLi <- combinations) {
      val part1: String = getFirstAndLast(conLi(0)) // getFirst(conLi(0))
      val part2: String = getFirst(conLi(1))//getFirst(conLi(1))
      val part3: String = getFirst(conLi(2))//getFirst(conLi(2))
      val part4: String = getFirst(conLi(3))//getFirst(conLi(3))
      val part5: String = getFirst(conLi(4))//getFirstAndLast(conLi(4))
